...
from BeastX-Py.misc._decorators import beastx_cmd
from BeastX-Py.misc._wrappers import eod, eor
...
BOTLOG_CHATID = BOTLOG = int(mrunal.get("LOG_CHANNEL"))
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "BeastX")
        OCR_SPACE_API_KEY = os.environ.get("OCR_SPACE_API_KEY", None)
        G_BAN_LOGGER_GROUP = int(mrunal.get("LOG_CHANNEL"))
        ...
        UB_BLACK_LIST_CHAT = [
            int(blacklist) for blacklist in mrunal.get("BLACKLIST_CHATS")
        ]
        ...
        PRIVATE_GROUP_BOT_API_ID = int(mrunal.get("LOG_CHANNEL"))
        PM_LOGGR_BOT_API_ID = int(mrunal.get("LOG_CHANNEL"))
